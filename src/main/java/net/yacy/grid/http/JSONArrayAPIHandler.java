...
public abstract class JSONArrayAPIHandler extends AbstractAPIHandler implements APIHandler {

    private static final long serialVersionUID = -2191240526448018369L;
    ...
    public ServiceResponse serviceImpl(final String protocolhostportstub, JSONObject params) throws IOException {
        ...
        JSONArray json = ClientConnection.loadJSONArray(urlstring);
        return new ServiceResponse(json);
    }
    
    public ServiceResponse serviceImpl(final String protocolhostportstub, Map<String, byte[]> params) throws IOException {
        JSONArray json = ClientConnection.loadJSONArray(protocolhostportstub + this.getAPIPath(), params);
        return new ServiceResponse(json);
    }
