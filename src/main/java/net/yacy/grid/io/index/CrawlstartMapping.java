...
public enum CrawlstartMapping implements MappingDeclaration {
	...
	user_id_s(MappingType.string, true, true, false, true, true, "id of the user who started the crawl", true), // shall be an internal ID which maps to user ID numbers
